# Isaac Chandler
# F23 Machine Design HW4.2
# Uses code from "3position_coupler_w_specified_ground.py"
...
res = shgo(dist_to_ground_joints, bounds=((-10,10),(-10,10),(-10,10),(-10,10)), options={'f_min': 0.001, 'maxev': 100})
print(res.message)
print(res.fun)
