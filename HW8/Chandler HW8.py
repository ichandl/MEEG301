# Isaac Chandler
# Machine Design F23
# Homework 8, Motor Sizing
# Uses code from "Maxon_118888.py"

import numpy as np
import matplotlib.pyplot as plt

# motor constants
V_nom = 9           # nominal voltage [V]
w_nl = 52500         # no-load speed [rpm]
i_nl = 118/1000        # no-load current [A]
T_nom = 1.63         # nominal torque [mNm]
w_nom = 45600        # nominal speed [rpm]
T_stall = 13        # stall torque [mNm]
kt = 1.61              # torque constant [mNm/A]
w_max = 65000        # max speed [rpm]

# loading condition (to be driven through gearhead)
T_load = 20         # load torque [mNm]
w_load = 180         # load speed [rpm]
